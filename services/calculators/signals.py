...
from calculators.usecases import (
    ...
    ration_calculation_cache_use_case,
    weight_calculation_cache_use_case,
)
...
def clear_weight_calculation_cache_signal(sender, instance: WeightCalculationUseCase, **kwargs):
    weight_calculation_cache_use_case.cache_queryset_key()
    weight_calculation_cache_use_case.delete_object_cache(instance.id)
    weight_calculation_cache_use_case.delete_retrieve_cache(instance.id)
...
def clear_ration_calculation_signal(sender, instance: RationCalculationUseCase, **kwargs):
    ration_calculation_cache_use_case.cache_queryset_key()
    ration_calculation_cache_use_case.delete_object_cache(instance.id)
    ration_calculation_cache_use_case.delete_retrieve_cache(instance.id)
